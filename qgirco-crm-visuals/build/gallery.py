...
<title>QGIRCO CRM — Solution Visuals</title><style>{css}</style></head>
<body>{HEAD}
{body}
<footer>QGIRCO Enterprise CRM Implementation · Technical Proposal · Microsoft Dynamics 365 and Salesforce solution visuals · Trion Technology &times; Volge.
Company reference &ldquo;QGIRCO&rdquo; per client brief (source documents: QGIRCO).</footer>
</body></html>"""


def build_readme():
    lines = ["# QGIRCO Enterprise CRM — Solution Visuals", "",
             "Professional, enterprise-grade architecture and requirement-realization visuals for the",
             "QGIRCO (Qatar General Insurance & Reinsurance Company) CRM implementation technical proposal,",
             "covering two independently engineered options: **Microsoft Dynamics 365** and **Salesforce**.",
             "",
             "Every visual is tailored to the QGIRCO RFP, BRD and Technical Proposal — not generic CRM art.",
             "Each requirement is shown as a realistic product screen (with QGIRCO insurance data: QID,",
             "policy numbers, Azentio, WhatsApp/WABA, SkipCash, 3CX, Insursa portals) annotated to show how",
             "the platform delivers it.",
             "",
             "> Note: the client brief refers to the company as **QGIRCO**; the source documents name it",
             "> **QGIRCO (Qatar General Insurance & Reinsurance Company)**. Visuals use QGIRCO per the brief.",
             "",
             "## How to view", "",
