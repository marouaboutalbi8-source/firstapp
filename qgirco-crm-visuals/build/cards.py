# -*- coding: utf-8 -*-
"""Per-requirement platform-UI mockup cards for QGIRCO."""
from appkit import *
...
def c_r1(pf, ax, ay, aw, ah, req):
    ...
    s.append(txt(ix + 74, ry + 48, "Enterprise ID  QGI-CUST-004182", size=10.6, color=UI["sub"], weight="600"))
    # badges
    bx = ix + 74
...
def c_r5(pf, ax, ay, aw, ah, req):
    ...
    s.append(txt(rxr + 58, top + 76, "QGI-CUST-004182 · VIP", size=9.4, color=UI["sub"], weight="500"))
    cy2 = top + 100
...
def c_r19(pf, ax, ay, aw, ah, req):
    ...
    rows = [
        ["Ahmed Al-Kuwari", "QGI-CUST-004182", CORP, "3", "N. Al-Sadi", "Doha"],
        ["Ooredoo Q.S.C.", "QGI-CUST-002210", CORP, "6", "N. Al-Sadi", "Doha"],
        ["Fatima Al-Ansari", "QGI-CUST-006654", RET, "2", "S. Kamal", "Al Wakrah"],
        ["Qatar Steel", "QGI-CUST-001098", CORP, "4", "N. Al-Sadi", "Mesaieed"],
        ["Khalid Rahman", "QGI-CUST-008321", RET, "1", "A. Nabil", "Doha"],
        ["Mannai Corporation", "QGI-CUST-003377", CORP, "5", "N. Al-Sadi", "Doha"],
        ["Al Meera Group", "QGI-CUST-002984", CORP, "3", "N. Al-Sadi", "Doha"],
        ["Doha Bank", "QGI-CUST-001540", CORP, "7", "N. Al-Sadi", "Doha"],
        ["Sara Ibrahim", "QGI-CUST-009011", RET, "2", "A. Nabil", "Lusail"],
    ]
...
def c_r20(pf, ax, ay, aw, ah, req):
    ...
    rows = [
        ...
        ["Woqod energy package", "Woqod", stg("Qualified", "#3E7CB1"), "220,000", "18 Sep", "R. Karim"],
        ["Milaha marine cargo", "Milaha", stg("New", "#94A3B2"), "150,000", "11 Oct", "R. Karim"],
